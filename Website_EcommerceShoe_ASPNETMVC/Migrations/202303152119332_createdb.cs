    ...
    public partial class createdb : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        dateUpProduct = c.DateTime(nullable: false),
                ...
                .ForeignKey("dbo.Categories", t => t.idCar)
                .Index(t => t.idCar)
                .Index(t => t.idBrand);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Products", "idCar", "dbo.Categories");
            ...
            DropIndex("dbo.Products", new[] { "idCar" });
